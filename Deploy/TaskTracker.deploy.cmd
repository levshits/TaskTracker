...
set _DeploySetParametersFile=%RootPath%TaskTracker.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%TaskTracker.zip" (
echo "%RootPath%TaskTracker.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%TaskTracker.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='obj\\Debug\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='TaskTracer\\App_Data$'
) else (
...
:usage
echo =========================================================
if not exist "%RootPath%TaskTracker.deploy-readme.txt" (
...
start notepad "%RootPath%TaskTracker.deploy-readme.txt"
)
echo =========================================================
goto :eof
